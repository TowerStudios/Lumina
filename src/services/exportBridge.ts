...
const OPEN_SINGLE_EXPORT_EVENT = 'Lumina:open-single-export'
const EXPORT_SESSION_STATUS_EVENT = 'Lumina:export-session-status'
const EXPORT_SESSION_STATUS_REQUEST_EVENT = 'Lumina:export-session-status-request'
const SINGLE_EXPORT_DIALOG_STATUS_EVENT = 'Lumina:single-export-dialog-status'
